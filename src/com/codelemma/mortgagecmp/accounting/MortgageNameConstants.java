...
public class MortgageNameConstants {
    ...
    private static String[] mortgage_type_items = {FIXED_RATE_VARIABLE_PRINCIPAL, FIXED_RATE_FIXED_PRINCIPAL};
	...
	public static int getTypeInteger(String type_name) {
		if (type_name != FIXED_RATE_VARIABLE_PRINCIPAL && type_name != FIXED_RATE_FIXED_PRINCIPAL) {
			return 0;
		}
