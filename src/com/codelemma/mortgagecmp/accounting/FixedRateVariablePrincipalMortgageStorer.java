...
public class FixedRateVariablePrincipalMortgageStorer implements MortgageStorer<FixedRateVariablePrincipalMortgage> {
	...
	public FixedRateVariablePrincipalMortgageStorer(Storage storage) {
		this.storage = storage;
	}

	@Override
	public String getTag() {
		return FIXED_RATE_VARIABLE_PRINCIPAL;
	}
	...
	public Mortgage load(int id) throws StorageException {
		...
		FixedRateVariablePrincipalMortgageFactory mfactory = new FixedRateVariablePrincipalMortgageFactory();
	 ...
	 */
	@Override
	public void save(FixedRateVariablePrincipalMortgage mortgage) throws StorageException {
	...
	/**
	 * Removes a mortgage and keyed with a given prefix from
	 * storage. Assumes storage has been opened for writing.
	 */
	@Override
	public void remove(FixedRateVariablePrincipalMortgage mortgage) throws StorageException {
		String prefix = Integer.toString(mortgage.getId());
